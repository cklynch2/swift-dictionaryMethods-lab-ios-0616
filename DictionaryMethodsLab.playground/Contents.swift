 ...
 */
// write your code here
for characterCategory in starWarsCharacters.keys {
    print(characterCategory)
}
 ...
 */
// write your code here
if let jedis = starWarsCharacters.updateValue(starWarsJedi, forKey: "Jedi") {
 ...
 */
// write your code here
if let bountyHunters = starWarsCharacters.removeValueForKey("Bounty Hunters") {
    print("Removed Bounty Hunters")
} else {
    print ("Bounty Hunters did not exist as a key.")
}
...
print("Has Aayla been added? \(starWarsCharacters["Jedi"])")
 ...
 */
// Was the only problem the typo with the key? "Heros" vs "Heroes"... It worked after I fixed this typo.
